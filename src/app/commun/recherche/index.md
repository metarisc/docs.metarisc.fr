...
Une série de filtres vous est proposée :
- Libellé : nom de l'ERP
- Références Extérieures : identifiant qui provient de la reprise de données
- Catégorie : catégorie de l'ERP
- Type : classification du type de l'ERP
- Activité : activité de l'ERP
...
Vous avez la possibilité d'exporter vos résultats de recherche sur un tableur.
...
4. Sélectionner le document .csv téléchargé précédemment, une fenêtre assistant importation s'ouvre.
