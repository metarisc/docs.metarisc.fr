...
1. Accéder au module de création ERP en cliquant sur Créer un ERP dans le menu de la barre latérale gauche.
...
La première étape consiste à localiser l'ERP.
...
4. L'adresse se reporte automatiquement dans la seconde partie du formulaire. Si, les adresses proposées ne correspondent pas, vous avez la possibilité de modifier manuellement l'adresse.
    ...
    ***Attention*** : *ici Arrondissement fait référence à la division administrative des villes de Paris, Lyon, Marseille et non de la division administrative du département*
...
Voici certaines précisions pour les champs présents sur cette page :

- **Dénomination sociale** : le libellé de l'établissement en texte libre. Par la suite, vous pourrez utiliser ce libellé dans le module de recherche.

- **Statut** : à sélectionner entre Reprise de données / Ouvert / Projet / Fermé / Itinérant Périodique / Erreur saisie.

    *Dans le dernier cas "Erreur saisie", il a vocation à être utilisé lorsque l’ERP n’est pas correct pour X raisons. La suppression d’un ERP n’étant pas possible, vous pouvez indiquer que cet ERP est à considérer comme une erreur.*

- **Références externes** : Il s'agit de pouvoir renseigner des références extérieures au logiciel Metarisc. Exemple de cas d'utilisation : L'identifiant RNB (Référentiel Nationale Bâtimentaire), une ancienne dénomination sociale, la référence de l'ERP sur un autre logiciel... Par la suite, vous pourrez utiliser ces références extérieures dans le module de recherche.
...
Dans cette étape, vous pouvez joindre des documents qui apparaitront dans la fiche d'identité de l'ERP (formats de document autorisés : pdf, png, jpg, jpeg, bmp, gif) soit en glisser-déposer, ou en parcourant votre explorateur de fichiers.
